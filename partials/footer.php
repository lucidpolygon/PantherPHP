<footer class="bg-white border-t border-gray-200 mx-auto max-w-7xl">
    <div class="px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
            <div class="px-5 py-2">
                <a href="#" class="text-base leading-6 text-gray-700 hover:text-black">
                    Terms & Conditions
                </a>
            </div>
            <div class="px-5 py-2">
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-700">
            &copy; 2024 <?php echo ($project_name) ?>. All rights reserved.
        </p>
    </div>
</footer>
